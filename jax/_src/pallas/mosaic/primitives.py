...
def _get_dma_effects(
  ...
  n_src_transforms = len(_dma_tree_leaves(src_transforms_avals))
  n_dst_transforms = len(_dma_tree_leaves(dst_transforms_avals))
  n_dst_sem_transforms = len(_dma_tree_leaves(dst_sem_transforms_avals))
